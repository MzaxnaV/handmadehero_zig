...
pub fn build(b: *std.Build) void {
    ...
    // TODO (Manav): this should instead be passed to the preprocessor tool so it removed all the autogenerated content.
    ...
    // TODO (Manav): add runtime arg which uses PROFILE
