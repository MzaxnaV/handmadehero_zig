...
test "math" {
    ...
    try testing.expectEqual(math.add(vec1, vec2).x, 6);
    try testing.expectEqual(math.add(vec1, vec2).y, 2);

    try testing.expectEqual(math.sub(vec1, vec2).x, -4);
    try testing.expectEqual(math.sub(vec1, vec2).y, 2);

    try testing.expectEqual(math.neg(vec1).x, -1);
    try testing.expectEqual(math.neg(vec1).y, -2);

    try testing.expectEqual(math.scale(vec1, 2).x, 2);
    try testing.expectEqual(math.scale(vec1, 2).y, 4);
