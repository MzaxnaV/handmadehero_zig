...
fn LoadAssetWorkDirectly(work: *load_asset_work) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__2 = debug.TIMED_BLOCK__impl(2, @src()).Init(.{});
    defer __t_blk__2.End();
    // AUTOGENERATED ----------------------------------------------------------
...
fn AcquireAssetMemory(assets: *game_assets, size_: u32, assetIndex: u32) ?*asset_memory_header {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__3 = debug.TIMED_BLOCK__impl(3, @src()).Init(.{});
    defer __t_blk__3.End();
    // AUTOGENERATED ----------------------------------------------------------
...
pub fn LoadBitmap(assets: *game_assets, ID: h.bitmap_id, immediate: bool) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__4 = debug.TIMED_BLOCK__impl(4, @src()).Init(.{});
    defer __t_blk__4.End();
    // AUTOGENERATED ----------------------------------------------------------
...
pub fn LoadFont(assets: *game_assets, ID: h.font_id, immediate: bool) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__5 = debug.TIMED_BLOCK__impl(5, @src()).Init(.{});
    defer __t_blk__5.End();
    // AUTOGENERATED ----------------------------------------------------------
...
pub fn LoadSound(assets: *game_assets, ID: h.sound_id) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__6 = debug.TIMED_BLOCK__impl(6, @src()).Init(.{});
    defer __t_blk__6.End();
    // AUTOGENERATED ----------------------------------------------------------
...
pub fn GetBestMatchAssetFrom(assets: *game_assets, typeID: h.asset_type_id, matchVector: *asset_vector, weightVector: *asset_vector) u32 {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__7 = debug.TIMED_BLOCK__impl(7, @src()).Init(.{});
    defer __t_blk__7.End();
    // AUTOGENERATED ----------------------------------------------------------
...
fn GetRandomAssetFrom(assets: *game_assets, typeID: h.asset_type_id, series: *h.random_series) u32 {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__8 = debug.TIMED_BLOCK__impl(8, @src()).Init(.{});
...
fn GetFirstAssetFrom(assets: *game_assets, typeID: h.asset_type_id) u32 {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__9 = debug.TIMED_BLOCK__impl(9, @src()).Init(.{});
