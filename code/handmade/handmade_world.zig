...
pub fn GetWorldChunk(memoryArena: ?*h.data_ns.memory_arena, w: *world, chunkX: i32, chunkY: i32, chunkZ: i32) ?*world_chunk {
    debug.TIMED_FUNCTION(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__42 = debug.TIMED_FUNCTION__impl(42, @src()).Init(.{});
    defer __t_blk__42.End();
    // AUTOGENERATED ----------------------------------------------------------
...
inline fn RecanonicalizeCoord(chunkDim: f32, tile: *i32, tileRel: *f32) void {
    const offSet = h.intrinsics_ns.RoundF32ToInt(i32, tileRel.* / chunkDim);
    tile.* +%= offSet;
...
pub inline fn Substract(w: *const world, a: *const world_position, b: *const world_position) h.v3 {
    ...
    const result = h.Add(h.math_ns.Hammard(w.chunkDimInMeters, dTile), h.Sub(a.offset_, b.offset_));
...
pub fn ChangeEntityLocationRaw(arena: *h.data_ns.memory_arena, w: *world, lowEntityIndex: u32, oldP: ?*const world_position, newP: ?*const world_position) void {
    debug.TIMED_FUNCTION(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__43 = debug.TIMED_FUNCTION__impl(43, @src()).Init(.{});
    defer __t_blk__43.End();
    // AUTOGENERATED ----------------------------------------------------------
...
pub fn ChangeEntityLocation(arena: *h.data_ns.memory_arena, w: *world, lowEntityIndex: u32, lowEntity: *h.data_ns.low_entity, newPInit: world_position) void {
    debug.TIMED_FUNCTION(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__44 = debug.TIMED_FUNCTION__impl(44, @src()).Init(.{});
    defer __t_blk__44.End();
    // AUTOGENERATED ----------------------------------------------------------

    var oldP: ?*const world_position = null;
    var newP: ?*const world_position = null;

    if (!h.entity_ns.IsSet(&lowEntity.sim, @intFromEnum(h.sim_region_ns.sim_entity_flags.NonSpatial)) and IsValid(lowEntity.p)) {
        oldP = &lowEntity.p;
    }
    ...
    if (newP) |p| {
        lowEntity.p = p.*;
        h.entity_ns.ClearFlags(&lowEntity.sim, @intFromEnum(h.sim_region_ns.sim_entity_flags.NonSpatial));
    } else {
        lowEntity.p = NullPosition();
        h.entity_ns.AddFlags(&lowEntity.sim, @intFromEnum(h.sim_region_ns.sim_entity_flags.NonSpatial));
    }
}
