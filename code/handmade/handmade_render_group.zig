...
pub const loaded_bitmap = extern struct {
    ...
    pub fn DrawRectangle(buffer: *const loaded_bitmap, vMin: h.v2, vMax: h.v2, colour: h.v4, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__4 = debug.TIMED_BLOCK__impl(4, @src()).Init(.{});
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__5 = debug.TIMED_BLOCK__impl(5, @src()).Init(.{});
        ...
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__6 = debug.TIMED_BLOCK__impl(6, @src()).Init(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__7 = debug.TIMED_BLOCK__impl(7, @src()).Init(.{});
        ...
        if (fillRect.HasArea()) {
            ...
            // AUTOGENERATED ----------------------------------------------------------
            const __t_blk__8 = debug.TIMED_BLOCK__impl(8, @src()).Init(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
    ...
    pub fn ChangeSaturation(buffer: *const loaded_bitmap, level: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__9 = debug.TIMED_BLOCK__impl(9, @src()).Init(.{});
    ...
    pub fn DrawBitmap(buffer: *const loaded_bitmap, bitmap: *const loaded_bitmap, realX: f32, realY: f32, cAlpha: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__10 = debug.TIMED_BLOCK__impl(10, @src()).Init(.{});
    ...
    pub fn DrawMatte(buffer: *const loaded_bitmap, bitmap: *const loaded_bitmap, realX: f32, realY: f32, cAlpha: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__11 = debug.TIMED_BLOCK__impl(11, @src()).Init(.{});
...
fn GetRenderEntityBasisP(transform: *const render_transform, originalP: h.v3) entity_basis_p_result {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    const __t_blk__12 = debug.TIMED_BLOCK__impl(12, @src()).Init(.{});
...
pub const render_group = struct {
    ...
    fn PushRenderElements(self: *Self, comptime t: render_group_entry_type) ?*align(1) t.Type() {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__13 = debug.TIMED_BLOCK__impl(13, @src()).Init(.{});
    ...
    fn RenderGroupToOutput(self: *Self, outputTarget: *loaded_bitmap, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__14 = debug.TIMED_BLOCK__impl(14, @src()).Init(.{});
    ...
    pub fn NonTiledRenderGroupToOutput(self: *Self, outputTarget: *loaded_bitmap) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__15 = debug.TIMED_BLOCK__impl(15, @src()).Init(.{});
    ...
    pub fn TiledRenderGroupToOutput(self: *Self, renderQueue: *platform.work_queue, outputTarget: *loaded_bitmap) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__16 = debug.TIMED_BLOCK__impl(16, @src()).Init(.{});
...
pub fn BeginRender(group: ?*render_group) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    const __t_blk__17 = debug.TIMED_BLOCK__impl(17, @src()).Init(.{});
...
pub fn EndRender(group: ?*render_group) void {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    const __t_blk__18 = debug.TIMED_BLOCK__impl(18, @src()).Init(.{});
