...
pub const loaded_bitmap = extern struct {
    ...
    pub fn DrawRectangle(buffer: *const loaded_bitmap, vMin: h.v2, vMax: h.v2, colour: h.v4, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__13 = debug.TIMED_BLOCK__impl(13, @src()).Init(.{});
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__14 = debug.TIMED_BLOCK__impl(14, @src()).Init(.{});
        ...
        debug.TIMED_BLOCK(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__15 = debug.TIMED_BLOCK__impl(15, @src()).Init(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__16 = debug.TIMED_BLOCK__impl(16, @src()).Init(.{});
        ...
        if (fillRect.HasArea()) {
            ...
            debug.TIMED_BLOCK(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
            // AUTOGENERATED ----------------------------------------------------------
            var __t_blk__17 = debug.TIMED_BLOCK__impl(17, @src()).Init(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
    ...
    pub fn ChangeSaturation(buffer: *const loaded_bitmap, level: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__18 = debug.TIMED_BLOCK__impl(18, @src()).Init(.{});
    ...
    pub fn DrawBitmap(buffer: *const loaded_bitmap, bitmap: *const loaded_bitmap, realX: f32, realY: f32, cAlpha: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__19 = debug.TIMED_BLOCK__impl(19, @src()).Init(.{});
    ...
    pub fn DrawMatte(buffer: *const loaded_bitmap, bitmap: *const loaded_bitmap, realX: f32, realY: f32, cAlpha: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__20 = debug.TIMED_BLOCK__impl(20, @src()).Init(.{});
...
fn GetRenderEntityBasisP(transform: *const render_transform, originalP: h.v3) entity_basis_p_result {
    debug.TIMED_BLOCK(.{});
    // AUTOGENERATED ----------------------------------------------------------
    var __t_blk__21 = debug.TIMED_BLOCK__impl(21, @src()).Init(.{});
...
pub const render_group = struct {
    ...
    fn PushRenderElements(self: *Self, comptime t: render_group_entry_type) ?*align(1) t.Type() {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__22 = debug.TIMED_BLOCK__impl(22, @src()).Init(.{});
    ...
    fn RenderGroupToOutput(self: *Self, outputTarget: *loaded_bitmap, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__23 = debug.TIMED_BLOCK__impl(23, @src()).Init(.{});
    ...
    pub fn NonTiledRenderGroupToOutput(self: *Self, outputTarget: *loaded_bitmap) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__24 = debug.TIMED_BLOCK__impl(24, @src()).Init(.{});
