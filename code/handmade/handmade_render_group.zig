...
pub const loaded_bitmap = extern struct {
    ...
    pub fn DrawRectangle(buffer: *const loaded_bitmap, vMin: h.v2, vMax: h.v2, colour: h.v4, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__12 = debug.TIMED_BLOCK__impl(12, @src()).Init(.{});
    ...
    // zig fmt: on
    {
        ...
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__14 = debug.TIMED_BLOCK__impl(14, @src()).Init(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__15 = debug.TIMED_BLOCK__impl(15, @src()).Init(.{});
        ...
        if (fillRect.HasArea()) {
            ...
            // AUTOGENERATED ----------------------------------------------------------
            var __t_blk__16 = debug.TIMED_BLOCK__impl(16, @src()).Init(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
    ...
    pub fn ChangeSaturation(buffer: *const loaded_bitmap, level: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__17 = debug.TIMED_BLOCK__impl(17, @src()).Init(.{});
