...
pub const loaded_bitmap = extern struct {
    ...
    // zig fmt: on
    {
        ...
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__23 = debug.TIMED_BLOCK__impl(23, @src()).Init("PixelFIll", .{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        ...
        if (fillRect.HasArea()) {
            ...
            // AUTOGENERATED ----------------------------------------------------------
            var __t_blk__25 = debug.TIMED_BLOCK__impl(25, @src()).Init("PixelFill", .{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
