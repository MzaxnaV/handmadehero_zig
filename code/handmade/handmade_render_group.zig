...
pub const loaded_bitmap = extern struct {
    ...
    // zig fmt: on
    {
        ...
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__6 = debug.TIMED_BLOCK__impl(6, @src()).Init(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        ...
        if (fillRect.HasArea()) {
            ...
            // AUTOGENERATED ----------------------------------------------------------
            var __t_blk__8 = debug.TIMED_BLOCK__impl(8, @src()).Init(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
    ...
    pub fn DrawMatte(buffer: *const loaded_bitmap, bitmap: *const loaded_bitmap, realX: f32, realY: f32, cAlpha: f32) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        var __t_blk__11 = debug.TIMED_BLOCK__impl(11, @src()).Init(.{});
