...
pub const loaded_bitmap = extern struct {
    ...
    // zig fmt: on
    {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__2 = debug.TIMED_BLOCK__impl(2, @src()).Init(.{});
        ...
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__3 = debug.TIMED_BLOCK__impl(3, @src()).Init(.{ .hitCount = @intCast((xMax - xMin + 1) * (yMax - yMin + 1)) });
    ...
    // zig fmt: on
    {
        ...
        if (fillRect.HasArea()) {
            ...
            // AUTOGENERATED ----------------------------------------------------------
            const __t_blk__5 = debug.TIMED_BLOCK__impl(5, @src()).Init(.{ .hitCount = @intCast(@divFloor(fillRect.GetClampedRectArea(), 5)) });
...
pub const render_group = struct {
    ...
    fn RenderGroupToOutput(self: *Self, outputTarget: *loaded_bitmap, clipRect: h.rect2i, even: bool) void {
        debug.TIMED_BLOCK(.{});
        // AUTOGENERATED ----------------------------------------------------------
        const __t_blk__6 = debug.TIMED_BLOCK__impl(6, @src()).Init(.{});
